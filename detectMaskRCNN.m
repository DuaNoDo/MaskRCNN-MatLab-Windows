function [bboxes,scores,labels,finalMasks] = detectMaskRCNN(dlnet,maskSubnet,image,params)
% detectMaskRCNN runs prediction on a trained Mask R-CNN network
%
% Inputs:
% dlnet      - Pretrained Mask R-CNN dlnetwork
% maskSubnet - Pretrained mask branch of Mask R-CNN dlnetwork
% image      - RGB image to run prediction on. (H x W x 3)
% params     - Mask R-CNN network configuration object created using
